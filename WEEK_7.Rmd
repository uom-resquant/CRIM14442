...
Once you have done some coding, you should review the passages you have selected for a particular code. We covered this a bit earlier, but do so, double-click on the code you want in the List pane. This will open the code in the Detail pane. Each source that references the chosen code is listed and headed by a hyperlink back to the source.

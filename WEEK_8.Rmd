...
![](https://socviz.co/assets/fig-ch-01-chartjunk-life-expectancy.png)
...
![](https://socviz.co/assets/fig-ch-01-perception-hermann-grid-effect.jpg)
...
![](https://socviz.co/assets/fig-ch-01-mach-bands-horizontal.png)
...
![](https://socviz.co/assets/fig-ch-01-perception-adelson-checkershow.jpg)
...
And again, this will bring up a pop-up. Here, once again, you can add variables with the "Add" (or **+**) button. Below is the example for Windows.


![](imgs/stackedbar_4.png)
And below is the equivalent example for Mac:

![](imgs/selectdatamac.png)

Once you click on the "Add" button, the fields should appear empty, as before. Click in the text box next to "Name"(or "Series name"), and then click on the column header (variable name) for the next variable. Select the "Robbery Rate" column header. Then click in the text box next to "Y values" (or "Series values"),  and then select the values for robbery rate, just as you did before for a different column.

Then, you might get something like this?


![](imgs/stackedbar_5.png)
Are your bas next to one another, rather than stacked on top for one another? That's all good, it just means you selected such a bar chart. If you want to switch your type of chart after you've made it, you can do that just by right-clicking on it, selecting 'Change chart type' and then choosing a new one. In this case, you might just need to select the bar chart symbol that shows bars stacked.

Once you're happy with that, repeat these for every variable you want to add to your bar chart.

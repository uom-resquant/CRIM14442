...
This is the same data but visualised in a cyclical way. In this visualisation, it actually appears that there are two main peaks. The peaks that were previously identified as two separate, possibly independent peaks have now bridged into 1, and we can see that instead, there might be a continuum and an ongoing event from 9 pm to 2 am. It is sometimes important to consider the cyclical nature of some of your temporal variables and use the appropriate means to visualise them. 



It might be worth having a look at some examples of temporal data being visualised, as well as making our own visualisations of time. Here, we will focus on two approaches: **line graphs** and **heatmaps**. If you want, you can also read about **radar graphs**.
...
Then, find the conditional formatting tab (usually under 'Home') and select a colour scheme that works for you. Remember to consider whether red values should be high or low. Is a high number good? Or is it bad? 
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/GanttChartAnatomy.svg/1920px-GanttChartAnatomy.svg.png)
